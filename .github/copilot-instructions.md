...
3. Read `workspace/memory/YYYY-MM-DD.md` for today and yesterday. If either file is missing, create it immediately with a short placeholder or backfill note before continuing the session.
